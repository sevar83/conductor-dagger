...
final class ConductorMapKeys {
     ...
     * current compilation.
     */
    static ImmutableMap<Class<? extends Annotation>, TypeMirror> annotationsAndConductorTypes(
            Elements elements) {
        return ImmutableMap.copyOf(
                Stream.of(elements.getPackageElement("com.christianbahl.conductor"))
                        ...
                        .flatMap(ConductorMapKeys::classForAnnotationElement)
