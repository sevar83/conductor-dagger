...
/**
 * Generates the implementation specified in {@link ContributesControllerInjector}.
 */
final class ContributesControllerInjectorGenerator implements ProcessingStep {

    private final Filer filer;
    private final AndroidInjectorDescriptor.Validator validator;

    ContributesControllerInjectorGenerator(Filer filer, AndroidInjectorDescriptor.Validator validator) {
        this.filer = filer;
    ...
    public Set<? extends Class<? extends Annotation>> annotations() {
        return ImmutableSet.of(ContributesControllerInjector.class);
    }
        ...
        return methodBuilder("bindAndroidInjectorFactory")
                ...
                .returns(
                        parameterizedTypeName(
                                ...
                                WildcardTypeName.subtypeOf(descriptor.conductorType())))
