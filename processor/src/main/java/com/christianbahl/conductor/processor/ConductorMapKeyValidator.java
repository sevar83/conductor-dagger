 ...
 */
final class ConductorMapKeyValidator implements ProcessingStep {
    private final Elements elements;
    private final Types types;
    private final Messager messager;

    ConductorMapKeyValidator(Elements elements, Types types, Messager messager) {
    ...
    public Set<? extends Class<? extends Annotation>> annotations() {
        return ConductorMapKeys.annotationsAndConductorTypes(elements).keySet();
    }
    ...
    private void validateMethod(Class<? extends Annotation> annotation, ExecutableElement method) {
        ...
        TypeMirror frameworkType = ConductorMapKeys.annotationsAndConductorTypes(elements).get(annotation);
